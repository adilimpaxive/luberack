...
public  class AlignmentAdapter extends RecyclerView.Adapter<AlignmentAdapter.MyViewHolder> {

    private final LayoutInflater inflater;
    List<AlignmentData> productList= Collections.emptyList();
    Context _context;

    public AlignmentAdapter(Context context, List<AlignmentData> products) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        AlignmentData data = productList.get(position);
