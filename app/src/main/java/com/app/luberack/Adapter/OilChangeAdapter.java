...
public  class OilChangeAdapter extends RecyclerView.Adapter<OilChangeAdapter.MyViewHolder> {

    private final LayoutInflater inflater;
    List<OilChangeData> productList= Collections.emptyList();
    Context _context;

    public OilChangeAdapter(Context context, List<OilChangeData> products) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        OilChangeData data = productList.get(position);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if(pos != RecyclerView.NO_POSITION) {
                ...
                OilChangeData events = productList.get(pos);
                ...
                Log.e("OilAdapter :",""+events.getType());
