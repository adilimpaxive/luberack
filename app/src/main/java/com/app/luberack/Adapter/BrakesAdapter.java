...
public  class BrakesAdapter extends RecyclerView.Adapter<BrakesAdapter.MyViewHolder> {

    private final LayoutInflater inflater;
    List<BrakesData> productList= Collections.emptyList();
    Context _context;

    public BrakesAdapter(Context context, List<BrakesData> products) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        BrakesData data = productList.get(position);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if(pos != RecyclerView.NO_POSITION) {
                ...
                BrakesData events = productList.get(pos);
