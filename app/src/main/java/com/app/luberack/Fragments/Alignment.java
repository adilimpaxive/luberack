...
import com.app.giftfcard.Adapter.AlignmentAdapter;
...
public class Alignment extends Fragment {
    AlignmentAdapter adapterTop;
    AlignmentData data;
    ArrayList<AlignmentData> oilChangeDataList;
                   ...
                   /*// jsonArray.length();
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; i < homesArray.length(); i++) {
                            ...
                            oilChangeDataList.add(new AlignmentData(homeObj.getString("id"), homeObj.getString("img_url"), homeObj.getString("name"), homeObj.getString("address"), homeObj.getString("reviews"), homeObj.getString("lat"), homeObj.getString("type"), homeObj.getString("lng")));


                        }
                        adapterTop = new AlignmentAdapter(getContext(), oilChangeDataList);
