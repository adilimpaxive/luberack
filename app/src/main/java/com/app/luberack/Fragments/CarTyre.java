...
import com.app.giftfcard.Adapter.CarTyreAdapter;
import com.app.giftfcard.ModelClasses.CarTyreData;
...
public class CarTyre extends Fragment {
    CarTyreAdapter adapterTop;
    CarTyreData data;
    ArrayList<CarTyreData> oilChangeDataList;
                   ...
                   /*// jsonArray.length();
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; i < homesArray.length(); i++) {
                            ...
                            oilChangeDataList.add(new CarTyreData(homeObj.getString("id"), homeObj.getString("img_url"), homeObj.getString("name"), homeObj.getString("address"), homeObj.getString("reviews"), homeObj.getString("lat"), homeObj.getString("type"), homeObj.getString("lng")));


                        }
                        adapterTop = new CarTyreAdapter(getContext(), oilChangeDataList);
